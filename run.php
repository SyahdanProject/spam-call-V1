...
class MyCall {
	...
	* File : run.php
	* Author : Syahdan FR
	* Github : https://github.com/SyahdanProject
	* Catatan : File ini diawasi langsung oleh IndoSan
	* Date : 10-09-2022
